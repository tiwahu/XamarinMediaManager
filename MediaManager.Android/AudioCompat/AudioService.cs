...
{
    public class AudioService : MediaBrowserServiceCompat
    {
        ...
        public override void OnCreate()
        {
            ...
            _mediaSession = new MediaSessionCompat(this, nameof(AudioService));
        ...
        public void onPlaybackStart()
        {
            ...
            StartService(new Intent(ApplicationContext, typeof(AudioService)));
        }
        ...
        */
        ...
        {
            private WeakReference<AudioService> _weakReference;

            public DelayedStopHandler(AudioService service)
            {
                _weakReference = new WeakReference<AudioService>(service);
            }
